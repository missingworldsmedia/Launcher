...
namespace Launchpad.Launcher
{
    ...
    internal sealed class HTTPHandler
    {
        ...
        public string PostToForm( string rawRemoteURL, string username, string password )
        {
            ...
            string PostString = "AUTHACTION=AUTH&AUTHNAME=" + username + "&AUTHPASS=" + password;
            ...
            try
            {
                request = CreateHttpWebRequest(remoteURL, "foo", "bar", true);
		...
		public string GetRemoteManifestChecksum( string WhichManifest )
		{
			...
			checksum = ReadPatchFile (Config.GetManifestChecksumURL ( WhichManifest ));
