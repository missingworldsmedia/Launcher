...
namespace Launchpad.Launcher
{
	...
	internal sealed class GameHandler
	{
        ...
        /// <summary>
        /// Occurs when a manifest File is completed.
        /// </summary>
        public event ManifestProgressChangedEventHandler ManifestProgressChanged;
        /// <summary>
        ...
        /// The progress arguments object. Is updated during file download operations.
        /// </summary>
        private FileDownloadProgressChangedEventArgs ManifestArgs;
		...
		public GameHandler ()
		{
            ...
            ManifestArgs = new FileDownloadProgressChangedEventArgs();
		...
		private void InstallGameAsync ()
		{
			...
			try
			{
                ...
                ManifestArgs.TotalFiles = Manifest.Count;
                ...
                foreach (ManifestEntry Entry in Manifest)
				{
					...
					{
                        //no file, download it
                        ManifestArgs.FileName = LocalPath;
                        OnProgressChanged();
                        OnManifestChanged();
						fileReturn = Protocol.DownloadPatchFile (RemotePath, LocalPath, false);
					}					
                    ...
                    ManifestArgs.DownloadedFiles = i;
                }
		...
		private void RepairGameAsync ()
		{
			...
			try
			{
				...
				string RemoteManifestHash = Protocol.GetRemoteManifestChecksum ( "Game" );
				...
				{				
                    ...
                    ManifestArgs.FileName = Path.GetFileName(LocalPath);
        ...
        {
            if ( ManifestProgressChanged != null)
            {
                ManifestProgressChanged(this, ManifestArgs);
            }
        }
